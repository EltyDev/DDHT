...
label credits:
    ...
    pause 0.5
    $ consolehistory = []
    call updateconsole ("renpy.music.play(\"ddlc.ogg\")", "Jouer l'audio \"ddlc.ogg\"...")
    pause 1.0
    call hideconsole
...
label credits2:
    ...
    show credits_header "Idées et Conception du jeu" as credits_header_1 at credits_text_scroll_left
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/n_cg1.png\")", "n_cg1.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/n_cg1.png\")", "n_cg1.png supprimée avec succès.")
    show expression ("credits_cg2" + lockedtext) as credits_image_2 at credits_scroll_left
    show credits_header "Illustrations Personnages" as credits_header_2 at credits_text_scroll_right
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/n_cg2.png\")", "n_cg2.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/n_cg2.png\")", "n_cg2.png supprimée avec succès.")
    show expression ("credits_cg3" + lockedtext) as credits_image_1 at credits_scroll_right
    show credits_header "Décors" as credits_header_1 at credits_text_scroll_left
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/y_cg1.png\")", "y_cg1.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/y_cg1.png\")", "y_cg1.png supprimée avec succès.")
    show expression ("credits_cg4" + lockedtext) as credits_image_2 at credits_scroll_left
    show credits_header "Écriture" as credits_header_2 at credits_text_scroll_right
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/y_cg2.png\")", "y_cg2.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/y_cg2.png\")", "y_cg2.png supprimée avec succès.")
    show expression ("credits_cg5" + lockedtext) as credits_image_1 at credits_scroll_right
    show credits_header "Musique" as credits_header_1 at credits_text_scroll_left
    show credits_text "Dan Salvato" as credits_text_1 at credits_text_scroll_left
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/n_cg3.png\")", "n_cg3.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/n_cg3.png\")", "n_cg3.png supprimée avec succès.")
    show expression ("credits_cg6" + lockedtext) as credits_image_2 at credits_scroll_left
    show credits_header "Chant" as credits_header_2 at credits_text_scroll_right
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/y_cg3.png\")", "y_cg3.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/y_cg3.png\")", "y_cg3.png supprimée avec succès.")
    show expression ("credits_cg7" + lockedtext) as credits_image_1 at credits_scroll_right
    show credits_header "Remerciements spéciaux" as credits_header_1 at credits_text_scroll_left
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/s_cg1.png\")", "s_cg1.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/s_cg1.png\")", "s_cg1.png supprimée avec succès.")
    show expression ("credits_cg8" + lockedtext) as credits_image_2 at credits_scroll_left
    show credits_header "Remerciements spéciaux" as credits_header_2 at credits_text_scroll_right
    ...
    $ imagenum += 1
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/s_cg2.png\")", "s_cg2.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/s_cg2.png\")", "s_cg2.png supprimée avec succès.")
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/s_cg3.png\")", "s_cg3.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/s_cg3.png\")", "s_cg3.png supprimée avec succès.")
    ...
    if not persistent.clearall:
        call updateconsole ("os.remove(\"images/cg/m_cg1.png\")", "m_cg1.png supprimée avec succès.")
    else:
        call updateconsole_clearall ("os.remove(\"images/cg/m_cg1.png\")", "m_cg1.png supprimée avec succès.")

    call updateconsole ("os.remove(\"game/screens.rpy\")", "screens.rpy supprimé avec succès.")
    call updateconsole ("os.remove(\"game/gui.rpy\")", "gui.rpy supprimé avec succès.")
    call updateconsole ("os.remove(\"game/menu.rpy\")", "menu.rpy supprimé avec succès.")
    call updateconsole ("os.remove(\"game/script.rpy\")", "script.rpy supprimé avec succès.")
    $ pause(115.72 - (datetime.datetime.now() - starttime).total_seconds())
    call hideconsole
    show credits_ts
    show credits_text "Traduction francophone par la Team Yarashii et fait avec amour par":
    ...
    label postcredits_loop:
        ...
        show poem_end
        $ pause()
        call screen dialog(message="Erreur : Le fichier script est absent ou corrompu.\nVeuillez réinstaller le jeu.", ok_action=Quit(confirm=False))
        return
