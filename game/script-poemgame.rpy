...
label poem(transition=True):
    ...
    if persistent.playthrough == 0 and chapter == 0:
        call screen dialog("C'est l'heure d'écrire un poème !\n\nChoisis des mots qui pourraient plaire à ta fille\npréférée du club. Quelque chose de bien pourrait\nse produire avec quiconque appréciera\nle plus ton poème !", ok_action=Return())
    python:
